                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     if(isset($_POST[clear_submit]))
                     {
                       ...
                       $sql .="UPDATE `kyc_pan` SET `c_date` = '$date' WHERE `kyc_pan`.`kp_id` = '$_POST[kp_id]';";
                       $sql .="UPDATE `kyc_pan` SET `c_time` = '$time' WHERE `kyc_pan`.`kp_id` = '$_POST[kp_id]';";
                       $sql .="UPDATE `distributor` SET `pan_status` = 'c' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                       $sql .="UPDATE `distributor` SET `pan_card` = '$_POST[pan_no]' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                     ...
                     if(isset($_POST[clear_reject]))
                     {
                       ...
                       $sql1 .="UPDATE `distributor` SET `pan_status` = 'n' WHERE `distributor`.`d_id` = '$_POST[d_id]';";
                     ...
                     if(isset($_GET[d_id]))
                     {
                       ...
                       $sql2="UPDATE `kyc_pan` SET `status` = 'n' WHERE `kyc_pan`.`d_id` = '$_GET[d_id]';";
                       
                       $sql1 .="UPDATE `kyc_pan` SET `n_date` = '$date' WHERE `kyc_pan`.`d_id` = '$_GET[d_id]';";
                       $sql1 .="UPDATE `kyc_pan` SET `n_time` = '$time' WHERE `kyc_pan`.`d_id` = '$_GET[d_id]';";
                       $sql1 .="UPDATE `distributor` SET `pan_status` = 'n' WHERE `distributor`.`d_id` = '$_GET[d_id]';";
