                ...
                <div class="col-lg-6">
                    <form action="process_contactus.php" method="post">
                        <div class="me-contact-form">
                            <input type="text" placeholder="Name" name="name" id="full_name" class="form-control" required/>
                            <input type="text" placeholder="Mobile" name="mobile" id="mobile" class="form-control" required/>
                            <input type="text" placeholder="Email" name="email" id="email" class="form-control" data-valid="email" data-error="Email should be valid." required/>
                            <textarea placeholder="Message" name="message" id="message" class="form-control" required/></textarea>
                            <input type="submit" class="btn btn-primary btn-block" value="Submit" name="contact_submit">
