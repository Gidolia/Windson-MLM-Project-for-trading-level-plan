    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered" value ="<h2>Withdrawl history</h2>" id="datatable">
            <thead><tr><th>Sr. no.</th><th>Date / Time</th><th>amount Requested</th><th>Admin Charge</th><th>Trading Wallet</th><th>Amount Payable</th><th>Status</th></tr></thead>
            <?php
            $a=0;
            ...
            <tr>
                ...
                <td><?php echo $d[trading_walley];?></td>
                <td><?php echo $d[amt_paid];?></td>
                <td><?php if($d[status]=="Y"){echo "Paid";}
                elseif($d[status]=="N"){echo "Request Pending";}?></td>
            </tr>
            <?php
            }?>
        </table>
